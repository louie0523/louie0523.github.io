...
window.SITE = {
  ...
  /* 데브로그 (최신이 위) */
  devlogs: [
    {"date":"2026.09.02","project":"랜덤 초능력자 배틀로얄","end":"2026.09.26","title":"랜덤 능력자! 프로토타입 제작","tags":["Game System","UI","Tooling","Sound","Multiplayer"],"desc":"랜덤 초능력자의 기초 프로토타입을 개발했습니다! 이 부분도 데브로그로 쓰고 싶었는데 너무 잊고 있었네요.\n\n간단히 개발하 것들을 소개하자면 다음과 같습니다.\n- 포톤 기반 멀티 플레이어 세팅\n- HP,Movement,Attack 시스템\n- 플레이어간 동기화 시스템\n- 무기 및 무기 공격, 애니메이팅 툴 시스템\n- 캐릭터 패시브 및 스킬 툴 추가\n- 랜덤 능력 프로토타입 추가\n- 손 리깅, 모션별 손 동작, 손가락 ik 추가 및 툴 시스템\n- 원거리 무기(활,총기류,기타) 시스템 추가\n- 상점 추가\n- 인첸트 추가\n- 상자 & 인첸트 스톤 추가\n- UI 씬 분리 후 UI 작업중","thumb":"44.png","kind":"interlude"},
    {"kind":"interlude","date":"2026.06.01","end":"2026.09.25","title":"대회 시즌","desc":"5개월 동안 데브로그는 멈췄지만, 대회 준비와 출전에 집중한 기간이었습니다.","events":[{"date":"2026.06","name":"BIC 출품 준비","result":"이번엔 불발"},{"date":"2026.07","name":"청강게임대전","result":"우수상","tier":"excel"},{"date":"2026.08","name":"전국기능경기대회 게임개발 직종","result":"동메달","tier":"bronze"}],"tags":[],"project":""},
