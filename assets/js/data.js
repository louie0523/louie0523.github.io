...
window.SITE = {
  ...
  seasons: [
    {"id":2,"name":"Season 2","title":"랜덤 초능력자 배틀로얄","start":"2026.06.01","desc":"대회 시즌을 마치고 돌아왔습니다. 이번 시즌은 1인칭 멀티플레이 배틀로얄을 주력으로 개발합니다."},
  ...
  projects: [
    ...
    {"id":"gunner-rider","no":7,"status":"done","dim":"3D","title":"Gunner & Rider","img":"Image/project7.png","desc":"한 명은 쫓아오는 적을 처리하는 거너, 한 명은 말을 조종하는 라이더로 나눠 플레이하는 3D 협동 게임입니다.","tags":["Unity","3D","Co-op"],"dev":"dev/dev7.html","link":"https://bellocity.itch.io/ridder-gunner"},
  ...
  /* 데브로그 (최신이 위) */
  devlogs: [
    {"no":43,"date":"2026.09.26","project":"랜덤 초능력자 배틀로얄","tags":["Season 2","Multiplayer"],"thumb":"","title":"Season 2 시작 — 랜덤 초능력자 배틀로얄","desc":"대회 시즌을 마치고 다시 돌아왔습니다. Baldo Master는 잠시 멈추고, 이번 시즌은 죽을 때마다 초능력이 무작위로 바뀌는 1인칭 멀티플레이 배틀로얄을 주력으로 개발합니다. Unity 6 + Photon Fusion 2로 혼자 만들고 있습니다."},
    {"kind":"interlude","date":"2026.06.01","end":"2026.09.25","project":"","tags":[],"thumb":"","title":"대회 시즌","desc":"5개월 동안 데브로그는 멈췄지만, 대회 준비와 출전에 집중한 기간이었습니다.","events":[{"date":"2026.06","name":"BIC 출품 준비","result":"이번엔 불발"},{"date":"2026.07","name":"청강게임대전","result":"우수상","tier":"excel"},{"date":"2026.08","name":"전국기능경기대회 게임개발 직종","result":"동메달","tier":"bronze"}]},
